...
function App() {
  ...
  const [clientMessages, setClientMessages] = useState(['Hi..', 'How are you, buddy?']); // Hard coding old chat messages from friend
  ...
  const submitMessage = () => {
    newMessage && setUserMessages(state => [...state, newMessage.trim()]);
